...
?>
           <div class="space"> 
				   ...
				   <h6 class="box-link"><a href="manage_categories.php"><i class="fa-solid fa-file-circle-plus"> Add Categories</i></a> </h6>
						...
						<?php 
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span id='badgee' class='badge badge-edit'><a href='manage_categories.php?id=".$row['id']."'>Edit</a></span>&nbsp;";
